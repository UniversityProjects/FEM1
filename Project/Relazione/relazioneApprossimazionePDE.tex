...
\begin{theorem} [Lax-Milgram - 1954] \index{Lemma di Lax-Milgram} \label{Lemma di Lax-Milgram} \footnote{Questo lemma è stato in seguito generalizzato da Babuska \cite{babuska1971BLM}, in modo da considerare due spazi di appartenzenza diversi per $u$ e per $v$ e indebolendo la richiesta sulla coercività (richiedendo la coercività debole).}
\hfill \\
